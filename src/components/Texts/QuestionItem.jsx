    ...
    return (
        <div className={classes.container}>
            ...
            <div className={classes.questionItemPair}>
                <label className={classes.questionItemLabel} htmlFor="a">A: {props.a}</label>
            ...
            <div className={classes.questionItemPair}>
                <label className={classes.questionItemLabel} htmlFor="b">B: {props.b}</label>
            ...
            <div className={classes.questionItemPair}>
                <label className={classes.questionItemLabel} htmlFor="c">C: {props.c}</label>
            ...
            <div className={classes.questionItemPair}>
                <label className={classes.questionItemLabel} htmlFor="d">D: {props.d}</label>
